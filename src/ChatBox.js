...
export default function ChatBox({ conversationId, recipientId, onClose, userRole = 'customer' }) {
  ...
  // 🔔 Listen for messages
  useEffect(() => {
    if (!conversationId || !messagesRef) return;
  ...
  const sendMessage = async () => {
    ...
    if (!currentUserId || !messagesRef) return;
